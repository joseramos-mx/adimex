...
export const WA_DEMO    = `${waBase}?text=${encode("Hola, me gustaría agendar una demo.")}`
export const WA_VENTAS  = `${waBase}?text=${encode("Hola, tengo un proceso que quiero automatizar y me gustaría platicarlo.")}`
