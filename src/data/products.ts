...
const hmiProducts: Product[] = [
  ...
  },
  {
    ...
    tagline: "HMI capacitiva multi-touch de 7\" con resolución HD 1024×600 y certificación CE/RoHS",
    description:
      "El F007N es una HMI industrial con pantalla táctil capacitiva multi-touch de 7 pulgadas, resolución HD 1024×600 a 16:9 y profundidad de color de 24 bits. Diseñada para entornos industriales exigentes, ofrece la fluidez de un dispositivo moderno con la robustez requerida en piso de planta. Disponible en variantes con marco negro (F007N-BL) y certificación UL Listed (F007N-UL).",
    image: `${D}/64205bb5-84a0-471c-88ee-91b6ad585cb1.png`,
    features: [
      "Pantalla táctil capacitiva multi-touch de 7\" HD",
      "Resolución 1024×600 a 16:9 con 24 bits de color",
      "Procesador de alto rendimiento para grandes proyectos",
      "Puerto Ethernet integrado para comunicación industrial",
      "Variantes con marco negro (BL) y certificación UL (UL)",
      "Compatible con FlexSCADA y FlexCloud",
    ],
    specs: [
      { label: "Tamaño de pantalla", value: "7\" (17.8 cm)" },
      { label: "Resolución", value: "1024 × 600 (16:9)" },
      { label: "Tipo de pantalla", value: "Táctil capacitiva multi-touch" },
      { label: "Profundidad de color", value: "24 bits" },
      { label: "Procesador", value: "Alto rendimiento" },
      { label: "Conectividad", value: "1 × Ethernet" },
      { label: "Certificaciones", value: "CE, RoHS (UL en variante -UL)" },
      { label: "Variantes", value: "F007N, F007N-BL (marco negro), F007N-UL" },
    ],
    applications: [
      "Control de maquinaria industrial",
      "Supervisión de procesos en planta",
      "Interfaces de operador con UX moderna",
      "Equipos OEM y máquinas compactas",
  ...
  },
  {
    ...
    categoryLabel: "HMI",
    subcategory: "HMI Capacitiva",
    tagline: "HMI capacitiva de 10.1\" con IoT y Bluetooth integrados, orientación horizontal/vertical",
    description:
      "El F110 es una HMI capacitiva multi-touch de 10.1 pulgadas con resolución 800×1280 a 16:10 y profundidad de color de 24 bits. Incluye IoT y Bluetooth integrados y soporta orientación horizontal o vertical de la pantalla, lo que la hace ideal para tableros modernos, supervisión de líneas y dashboards industriales con conectividad cloud nativa.",
    image: `${D}/64205bb5-84a0-471c-88ee-91b6ad585cb1.png`,
    features: [
      "Pantalla capacitiva multi-touch de 10.1\" Full HD",
      "Resolución 800×1280 a 16:10 con 24 bits de color",
      "IoT y Bluetooth integrados de fábrica",
      "Orientación horizontal o vertical configurable",
      "Procesador de alto rendimiento con gran capacidad de almacenamiento",
      "Puerto Ethernet para comunicación industrial",
    ],
    specs: [
      { label: "Tamaño de pantalla", value: "10.1\" (25.6 cm)" },
      { label: "Resolución", value: "800 × 1280 (16:10)" },
      { label: "Tipo de pantalla", value: "Táctil capacitiva multi-touch" },
      { label: "Profundidad de color", value: "24 bits" },
      { label: "Conectividad", value: "Ethernet + IoT + Bluetooth integrados" },
      { label: "Orientación", value: "Horizontal / Vertical" },
      { label: "Procesador", value: "Alto rendimiento" },
      { label: "Variantes", value: "F110, F110C (capacitiva premium)" },
    ],
    applications: [
      "Tableros de supervisión de planta",
      "Dashboards industriales con IoT",
      "Equipos médicos y de laboratorio",
      "Quioscos industriales",
